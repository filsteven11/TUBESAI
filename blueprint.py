...
def draw_floor(ax, floor_number, room_names=None, start_room=None, goal_room=None):
    width, height = 12, 6
    room_width = width / 3
    F1R0 = height / 2
    F1R1 = height / 2
...
def draw_second_floor(ax, floor_number, room_names=None, start_room=None, goal_room=None):
    width, height = 12, 6
...
def draw_third_floor(ax, floor_number, room_names=None, start_room=None, goal_room=None):
    width, height = 12, 6
    room_width = width / 7.5
    room_height = height / 2
...
def draw_fourth_floor(ax, floor_number, room_names=None, start_room=None, goal_room=None):
    width, height = 12, 6
    room_width = width / 7.5
    room_height = height / 2
...
def draw_building_with_switching(room_names=None, start_floor=1, start_room=None, goal_room=None):
    start = start_room
    goal = goal_room
    ...
    def update_floor(floor):
        ax.clear()
        if floor == 1:
            draw_floor(ax, floor_number=1, room_names=room_names, start_room=start, goal_room=goal)
        elif floor == 2:
            draw_second_floor(ax, floor_number=2, room_names=room_names, start_room=start, goal_room=goal)
        elif floor == 3:
            draw_third_floor(ax, floor_number=3, room_names=room_names, start_room=start, goal_room=goal)
        elif floor == 4:
            draw_fourth_floor(ax, floor_number=4, room_names=room_names, start_room=start, goal_room=goal)
