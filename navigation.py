...
class IndoorNavigation:
    ...
    def create_graph(self):
        graph = {
            ...
            # Floor 2
            'Laboratorium Komputer': {'Lift F2': 1, 'Left Stairs F2': 2, 'Classroom 201': 1, 'Laboratorium Basis Data': 2},
            'Laboratorium Basis Data': {'Laboratorium Komputer': 2, 'Classroom 202': 1, 'Laboratorium Elektro': 2},
            'Laboratorium Elektro': {'Laboratorium Basis Data': 2, 'Classroom 204': 1, 'Right Stairs F2': 1},
            'Classroom 201': {'Classroom 202': 1, 'Lift F2': 1},
            ...
            'Classroom 205': {'Classroom 204': 1, 'Right Stairs F2': 1},
            'Lift F2': {'Left Stairs F2': 1, 'Lift F1': 3, 'Lift F3': 3, 'Laboratorium Komputer': 1, 'Classroom 201': 1},
            'Left Stairs F2': {'Lift F2': 1, 'Left Stairs F1': 6, 'Left Stairs F3': 6, 'Laboratorium Komputer': 2, 'Classroom 201': 2},
            'Right Stairs F2': {'Right Stairs F1': 6, 'Right Stairs F3': 6, 'Laboratorium Elektro': 1, 'Classroom 205': 1},

            # Floor 3
            'Laboratorium CRC': {'Lift F3': 1, 'Left Stairs F3': 2, 'Classroom 301': 1, 'Laboratorium OLB': 2},
            'Laboratorium OLB': {'Laboratorium CRC': 2, 'Classroom 302': 1, 'Laboratorium IoT': 2},
            'Laboratorium IoT': {'Laboratorium OLB': 2, 'Classroom 304': 1, 'Right Stairs F3': 1},
            'Classroom 301': {'Classroom 302': 1, 'Lift F3': 1},
            ...
            'Classroom 305': {'Classroom 304': 1, 'Right Stairs F3': 1},
            'Lift F3': {'Left Stairs F3': 1, 'Lift F2': 3, 'Lift F4': 3, 'Laboratorium CRC': 1, 'Classroom 301': 1},
            'Left Stairs F3': {'Lift F3': 1, 'Left Stairs F2': 6, 'Left Stairs F4': 6, 'Laboratorium CRC': 2, 'Classroom 301': 2},
            'Right Stairs F3': {'Right Stairs F2': 6, 'Right Stairs F4': 6, 'Laboratorium IoT': 1, 'Classroom 305': 1},

            # Floor 4
            'Laboratorium Cyber': {'Lift F4': 1, 'Left Stairs F4': 2, 'Classroom 401': 1, 'Laboratorium Akuntansi': 2},
            'Laboratorium Akuntansi': {'Laboratorium Cyber': 2, 'Classroom 402': 1, 'Laboratorium ML': 2},
            'Laboratorium ML': {'Laboratorium Akuntansi': 2, 'Classroom 404': 1, 'Right Stairs F4': 1},
            'Classroom 401': {'Classroom 402': 1, 'Lift F4': 1},
            ...
            'Classroom 405': {'Classroom 404': 1, 'Right Stairs F4': 1},
            'Lift F4': {'Left Stairs F4': 1, 'Lift F3': 3, 'Laboratorium Cyber': 1, 'Classroom 401': 1},
            'Left Stairs F4': {'Lift F4': 1, 'Left Stairs F3': 6, 'Laboratorium Cyber': 2, 'Classroom 401': 2},
            'Right Stairs F4': {'Right Stairs F3': 6, 'Laboratorium ML': 1, 'Classroom 405': 1},
        }
        return graph
